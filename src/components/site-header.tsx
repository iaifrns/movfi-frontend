...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 bg-background flex z-10 h-(--header-height) shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
